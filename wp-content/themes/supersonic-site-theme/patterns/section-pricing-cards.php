 ...
 * Slug: supersonic-site-theme/section-pricing-cards
 * Categories: supersonic-info
 * Keywords: pricing, plans, cards
 * Description: A three-card pricing or package section.
 */
?>
	...
	<div class="wp-block-columns is-not-stacked-on-mobile">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group has-contrast-color has-base-background-color has-text-color has-background" style="border-radius:var(--wp--custom--radius--medium);padding-top:var(--wp--preset--spacing--l);padding-right:var(--wp--preset--spacing--l);padding-bottom:var(--wp--preset--spacing--l);padding-left:var(--wp--preset--spacing--l)">
				...
				<!-- /wp:heading -->
				<!-- wp:paragraph {"fontSize":"heading-3"} -->
				<p class="has-heading-3-font-size"><strong>$0</strong></p>
				<!-- /wp:paragraph -->
				<!-- wp:list -->
		...
		<!-- wp:column -->
		<div class="wp-block-column">
			<!-- wp:group {"style":{"border":{"color":"var:preset|color|accent","radius":"var(--wp--custom--radius--medium)","width":"2px"},"shadow":"var:preset|shadow|medium"}} -->
