<?php
/**
 * Title: Section: Service Cards
 * Slug: supersonic-site-theme/section-service-cards
 * Categories: supersonic-cards
 * Keywords: services, cards, offers
 * Description: A service overview section with three editable cards and links.
 */
?>
<!-- wp:group {"metadata":{"name":"Section: Service Cards"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|section-medium","bottom":"var:preset|spacing|section-medium"}}},"layout":{"type":"constrained"}} -->
