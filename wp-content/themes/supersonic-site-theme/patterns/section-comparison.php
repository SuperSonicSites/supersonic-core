 ...
 * Slug: supersonic-site-theme/section-comparison
 * Categories: supersonic-info
 * Keywords: comparison, table, options
 * Description: A two-column comparison section for choices, approaches, or before-and-after framing.
 */
?>
<!-- wp:group {"metadata":{"name":"Section: Comparison"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|section-medium","bottom":"var:preset|spacing|section-medium"}}},"layout":{"type":"constrained"}} -->
